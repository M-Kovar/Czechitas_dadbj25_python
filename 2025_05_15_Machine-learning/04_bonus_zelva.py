...
# Ukázka vytvoření a ovládání želvy
import turtle as t
...
# Bonus: Objektově-orientovaný přístup
'''
import turtle as t
import random

# Vytvoření objektu reprezentujícího první želvu
t1 = t.Turtle()
t1.shape("turtle")
t1.speed(5)

# Vytvoření objektu reprezentujícího druhou želvu
t2 = t.Turtle()
t2.shape("circle")
t2.speed(5)
